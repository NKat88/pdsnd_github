...
def get_filters():
    ...
    print("OK! Gathering information for {}...".format(city.title()))
    ...
    print("Got it! We will provide information for {}...".format(month.title()))
    ...
    print("OK, will show data for {}...".format(day.title()))
